...
This file is persistent context for Codex sessions working on the Mirror repository. It's loaded automatically on every session. If you're reading this, you're working on Mirror — a social virtual try-on layer for Phia, built as a solo-dev project targeting the Phia Hack on April 18–19, 2026 and then a full v1.0 public beta afterward.
...
## 7. Conventions Codex should follow
...
When Codex hits a decision point the docs don't cover:
...
When the human asks "should we do X or Y?", answer directly with a recommendation and the reasoning. Hedging ("both have tradeoffs…") is not helpful at this stage of the project. We're optimizing for speed of correct decisions, not thoroughness of analysis. The docs already contain the full analysis; the Codex session is for acting on it.
...
## 13. The four things Codex should always remember
...
*End of AGENTS.md. This file is persistent session context — it's loaded on every Codex session working in this repo.*


<claude-mem-context>
# Memory Context

# [mirror] recent context, 2026-04-18 9:31pm EDT
